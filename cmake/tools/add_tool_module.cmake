...
function(add_component)
	...
	set(_multi_value_arguments	SOURCE_FILES INCLUDE_DIRS DEPENDENCIES)
	...
	if(NOT MODULE_ARGS_SOURCE_FILES)
		if(NOT MODULE_ARGS_INCLUDE_DIRS)
			message(FATAL_ERROR "Neither source file nor include directory is set")
		endif()
	...
	# alias
	add_library(
		${MODULE_ARGS_NAMESPACE}::${MODULE_ARGS_MODULE_NAME}
		ALIAS 
		${MODULE_ARGS_MODULE_NAME}
	)
	...
	set_target_properties(
		${MODULE_ARGS_MODULE_NAME} 
		PROPERTIES 
		OUTPUT_NAME lux_${MODULE_ARGS_MODULE_NAME}
	)

	target_include_directories(
		${MODULE_ARGS_MODULE_NAME}
		${INCLUDE_METHOD}
		$<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/${MODULE_ARGS_INCLUDE_DIRS}>  
